            ...
            <div class="card mb-0">
                ...
                <div class="card-body">
                    <div class="col-lg">
                        ...
                        <form action="<?= BASEURL; ?>/divisi" method="post" class="needs-validation" novalidate>
                        <input type="hidden" value="<?= $csrftoken ?>" name="csrftoken">
                        
                        <div class="form-group">
                            <label for="nama_divisi">Nama Divisi</label>
                            <input type="text" name="nama_divisi" id="nama_divisi" class="form-control" required maxLength="50" minLength="3" pattern="^[a-zA-Z ]*$" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="alias" id="alias" class="form-control" required maxLength="3" minLength="2" pattern="^[A-Z ]*$">
                            <div class="valid-feedback">Looks good!</div>
                            <div class="invalid-feedback">
