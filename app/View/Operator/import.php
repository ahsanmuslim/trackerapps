...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h4 mb-3 text-gray-800">Import operator</h1>
    <div class="text-left">
        ...
        <div class="col-lg-8">
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <div class="col-lg">
                    <form action="<?= BASEURL; ?>/operator/import" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group text-right mt-3">
                            <a href="<?= BASEURL; ?>/operator/download" class="btn btn-warning mr-2">
                                <span class="icon text-white-50">
