                            ...
                            <form action="<?= BASEURL ?>/report" method="post">
                                <div class="row">
                                    <div class="col-lg-4 my-1">
                                        <input type="date" class="form-control" name="tglawal" id="tglawal" value="<?= $data['tgl']['tglawal'] ?>" required>
                                    </div>
                                    <div class="col-lg-4 my-1">
                                        <input type="date" class="form-control" name="tglakhir" id="tglakhir" value="<?= $data['tgl']['tglakhir'] ?>" required>
                                    </div>
                                    <div class="col-lg-4 my-1">
